...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which is not a real thing? <br> A: code <br> B: ryan <br> C: matrix</html>");
		question3 = new JLabel("<html>Which is not a toy to toy with? <br> A: boy <br> B: not this one <br> C: girl</html>");
		question4 = new JLabel("<html>Which is a real fruit? <br> A: oaotmeal <br> B: Durian <br> C: Crainberry</html>");
...
if (question4.isShowing()) {
	...
	new Thread(()-> JOptionPane.showMessageDialog(null, "", "YOU CHEATED CLOSING PROGRAM", JOptionPane.ERROR_MESSAGE) ).start();
	try {
		Thread.sleep(3000);
